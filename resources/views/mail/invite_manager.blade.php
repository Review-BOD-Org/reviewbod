    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <tr>
            <td style="padding: 30px 20px;">
                ...
                <p style="color: #333333; font-size: 16px;">You've been invited to join {{ $workspace }} as a manager. Use the link below to accept your invitation and get started.</p>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 20px 0;">
                    <tr>
                        <td style="background-color: #4285F4; border-radius: 4px; padding: 12px 24px; text-align: center;">
                            <a href="{{url("/manager/invite/$workspace/$id")}}" style="color: white; text-decoration: none; font-weight: bold; display: inline-block;">Accept Invitation</a>
                        </td>
                    </tr>
                </table>
            </td>
