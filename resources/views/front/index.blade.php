...
<body class="bg-white">
    ...
    <nav class="bg-white  fixed w-full z-20 top-0 start-0">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul
                    class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 text-black">
                    <li>
                        <a href="#" class="block py-2 px-3 text-black  rounded-sm"
                            aria-current="page">Features</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-black  rounded-sm">How It Works</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-black  rounded-sm">Pricing</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-black  rounded-sm">FAQ</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <main class="pt-24" style="margin-top:50px">
        <div class="flex flex-col   mx-auto gap-4 rb-header">
            ...
            <p class="text-center text-[19px] w-[67%] self-center mt-5">Discover the power of ReviewBod — your AI-driven platform for streamlined performance reviews, team management, and data-driven insights.</span>
