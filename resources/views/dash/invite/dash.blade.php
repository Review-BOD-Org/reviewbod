...
<script>
    ...
    async function loadSidebarChatsOnly() {
        try {
            const response = await fetch('{{ route('invited.sidebar_chats') }}', {
                method: 'GET',
                headers: {
    ...
    async function createNewChat() {
        ...
        const newUrl = `${window.location.origin}/invited/dash`;
    ...
    function initstream() {
        ...
        id = getRandomId()
        ws = new WebSocket('wss://linked.reviewbod.com/ws');
...
<image id="image0_209_4633" width="381" height="381" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
    ...
    function placeholder() {
        ...
        <div class="flex flex-col items-center justify-center h-full px-8 py-16" id="placeholder">
            ...
            <p class="text-gray-600 text-center max-w-md leading-relaxed mb-6">
                Your {{ Auth('linear_user')->user()->space }} workspace is connected. Start a conversation to get AI insights on your tasks, priorities, and workflow patterns.
            </p>
    ...
    async function loadChats() {
        ...
        try {
            const response = await fetch('/invited/chat_data/' + (currentChatId ?
        ...
        $("#sendMessage").submit((event) => {
            ...
            if (ws.readyState === WebSocket.OPEN && messageInput.trim()) {
                ...
                const message = {
                    ...
                    space:'{{Auth('linear_user')->user()->space}}'
                };
    ...
    async function selectChat(chatId) {
        ...
        try {
            const response = await fetch(`/invited/chat_data/?chat_id=${chatId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
...
<image id="image0_209_4633" width="381" height="381" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
    ...
    async function loadMoreMessages() {
        ...
        try {
            const response = await fetch(
                `/invited/loadMoreMessages?chat_id=${currentChatId}&page=${currentPage + 1}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
    ...
    async function deleteChat(chatId, event) {
        ...
        try {
            const response = await fetch(`/invited/deleteChat`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
   ...
   const questions = [
    ...
    "Which of my tasks are currently overdue?", 
    "How many tasks do I have in each status?",
    "What's my task completion rate compared to last month?",
    "Which projects am I most active in?",
    "How many high-priority tasks do I currently have?",
    "What's my total estimated workload for this week?",
    "How many tasks have I completed vs. created this month?",
    "What's my longest-running incomplete task?",

    // 📊 Personal Platform Usage
    "Which platform do I use most for task management?",
    "What's my completion rate on Linear vs. Trello vs. Jira?",
    "How many tasks do I have on each platform?",
    "Which platform has my highest priority tasks?",
    "Where do I spend most of my estimated hours?",
    "Which platform has my oldest incomplete tasks?",

    // ⏱️ Personal Time Management
    "How many of my tasks are due in the next 7 days?",
    "What's my average time between task assignment and completion?",
    "Which of my tasks have been in progress the longest?",
    "How much estimated work do I have remaining this sprint?",
    "What's my task velocity (tasks completed per week)?",

    // 🚦 Personal Task Status & Workflow
    "How many of my tasks are currently in progress?",
    "What percentage of my tasks are completed vs. pending?",
    "Which of my tasks have no status assigned?",
    "How many tasks have I moved to 'Done' this week?",
    "What's my current workload distribution by status?",

    // 📌 Personal Priority Management
    "How are my tasks distributed by priority level?",
    "Which labels do I use most frequently?",
    "How many of my high-priority tasks are still incomplete?",
    "What's my focus area based on task labels?",
    "Which priority level takes me longest to complete?",

    // 👤 Personal Productivity Insights
    "What's my most productive day of the week?",
    "How has my task completion trend changed over time?",
    "What's my average daily task completion count?",
    "Which types of tasks do I complete fastest?",
    "How consistent is my task completion rate?",

    // 🧹 Personal Task Hygiene
    "Which of my tasks haven't been updated in over 30 days?",
    "How many of my tasks are missing due dates?",
    "Which of my tasks have no estimates assigned?",
    "How many stale tasks do I need to review?",
    "Which of my tasks need priority or status updates?"
];
    function suggest() {
   ...
   async function snapCapture(divId) {
    ...
    @if (!DB::table('user_metrics')->where(['userid' => Auth('linear_user')->id()])->exists())
        // Get modal elements
