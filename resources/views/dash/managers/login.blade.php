        ...
        <div class="w-1/2 h-full flex items-center justify-center">
            <div class="w-4/5 max-w-md">
                ...
                <form id="loginForm" class="space-y-6">
                    <div class="mb-6">
                        <label for="email" class="block text-lg font-medium text-gray-700 mb-2">Enter your manager login details to get started</label>
