...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Baloo+2:wght@400..800&family=Schibsted+Grotesk:ital,wght@0,400..900;1,400..900&family=Urbanist:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
...
<body class="bg-white h-screen flex">
    <!-- Sidebar -->
    @include('dash.managers.layouts.partials.sidebar')

    <!-- Main content -->
    {{-- <div class="flex-1 flex flex-col h-screen"> --}}
    <!-- Top navigation -->
    @include('dash.managers.layouts.partials.topnav')
    ...
    @include('dash.managers.layouts.partials.chat-button')
