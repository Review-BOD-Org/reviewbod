...
<div class=" border-r border-[#F1F2F7] flex flex-col h-screen">
    ...
    {{-- <div class="p-3">
        <div class="px-3 py-3 justify-between flex items-center cursor-pointer relative bg-white rounded-md"
            ...
            <div class="bg-gradient-to-r   w-6 h-6 rounded-md flex items-center justify-center mr-2 shadow-sm">
                @if (Auth('manager')->user()->service)
                    <img src="/images/{{ Auth('manager')->user()->service }}.webp" />
                @endif
            </div>
    ...
    <div class="mt-6 px-3 flex-grow">
        ...
        <!-- Menu items -->
        <nav class="space-y-[50px]">
            <a href="/manager/dash"
                class="flex  items-center justify-center px-3 py-2 text-sm font-medium text-gray-900 rounded-md {{ request()->routeIs('manager/dash') ? 'bg-gray-100' : 'hover:bg-gray-50 hover:text-gray-900' }}">
            ...
            <div class="relative">
                <div onclick="location.href='/manager/users'"
            ...
            <div class="relative">
                <div onclick="location.href='/manager/settings'"
                    class="flex items-center justify-center px-3 py-2 text-sm font-medium text-gray-600 rounded-md hover:bg-gray-50 hover:text-gray-900 cursor-pointer">
