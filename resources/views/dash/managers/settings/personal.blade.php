         ...
         <form id="personalInfoForm" class="space-y-6 p-5">
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                 ...
                 <div>
                     ...
                     <input type="text" name="name" value="{{ auth("managers")->user()->name }}"
                 ...
                 <div>
                     ...
                     <input type="email" name="email" value="{{ auth("managers")->user()->email }}"
                 ...
                 <div>
                     ...
                     <input type="tel" name="phone" value="{{ auth("managers")->user()->phone }}"
                         class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="(123) 456-7890">
                 </div>

                 <!-- Company Name -->
                 <div>
                     <label class="block text-sm font-medium text-gray-500 mb-1">WorkSpoace</label>
                     <input type="text"  value="{{ auth("managers")->user()->workspace }}"
                         class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="Your company name" readonly>
                 </div>
             </div>
