                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="relative flex items-center">
                                        ...
                                        <div class="flex gap-2 ml-5">
                                            @foreach (DB::table('platform_users')->where([
                'manager_id' => Auth("managers")->id(),
            ])->select("source as type")->distinct()->get() as $d)
                                    ...
                                    <tbody class="divide-y divide-gray-100">
                                        @foreach ($data as $user)
                                            <tr class="hover:bg-gray-50/50" data-user-id="{{ $user->iid }}">
                                                ...
                                                <td class="py-4 px-6 items-center text-center">

                                                     <button class="" onclick="location.href='/manager/user/{{$user->id}}'">
                                                            <i class="fa fa-chevron-right text-[30px] text-[#cb964f]"></i>
                                                        </button>
