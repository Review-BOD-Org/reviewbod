...
@section('content')
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div style="max-width:75%;min-width:75%" class="w-[75%] flex flex-col h-full min-w-0">
            @include('dash.managers.layouts.partials.head')
...
@php
    ...
    $encryptedChat = sodium_crypto_secretbox(1, $nonceChat, $key);
...
<script>
    ...
    async function loadSidebarChatsOnly() {
        try {
            const response = await fetch('/manager/sidebar_chats', {
                method: 'GET',
                headers: {
    ...
    async function createNewChat() {
        ...
        const newUrl = `${window.location.origin}/manager/dash`;
    ...
    function initstream() {
        ...
        id = getRandomId()
        ws = new WebSocket('wss://manager.reviewbod.com/ws');
...
<image id="image0_209_4633" width="381" height="381" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
    ...
    function placeholder() {
        ...
        <div class="flex flex-col items-center justify-center h-full px-8 py-16" id="placeholder">
            ...
            <p class="text-gray-600 text-center max-w-md leading-relaxed mb-6">
                Your {{ Auth('managers')->user()->space }} workspace is connected. Start a conversation to get AI insights on your tasks, priorities, and workflow patterns.
            </p>
    ...
    async function loadChats() {
        ...
        try {
            const response = await fetch('/manager/chat_data/' + (currentChatId ?
        ...
        $("#sendMessage").submit((event) => {
            ...
            if (ws.readyState === WebSocket.OPEN && messageInput.trim()) {
                ...
                const message = {
                    ...
                    chat_id: chatIdFromPath == "dash" ? "" : chatIdFromPath,
                    space:'{{Auth('managers')->user()->workspace}}'
                };
    ...
    async function selectChat(chatId) {
        ...
        try {
            const response = await fetch(`/manager/chat_data/?chat_id=${chatId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
...
<image id="image0_209_4633" width="381" height="381" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
    ...
    async function loadMoreMessages() {
        ...
        try {
            const response = await fetch(
                `/manager/loadMoreMessages?chat_id=${currentChatId}&page=${currentPage + 1}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
    ...
    async function deleteChat(chatId, event) {
        ...
        try {
            const response = await fetch(`/manager/deleteChat`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
...
const questions = [
    ...
    "How many tasks have my team members completed this month?",
    "What is the average task completion time across the team?",
    "Which team members have the most overdue tasks?",
    "How are tasks distributed across different statuses for my team?",
    "How does this month’s task completion rate compare to last month?",
    "Which projects are my team members most active in?",
    "How many high-priority tasks are currently assigned across my team?",
    "What's the total estimated workload for my team this week?",
    "How many tasks have been completed vs. created by the team this month?",
    "Which incomplete tasks have been open the longest across the team?",

    // 📊 Team Platform Usage
    "Which task management platforms are most used by my team?",
    "What is the completion rate by platform (Linear vs. Trello vs. Jira) for my team?",
    "How many tasks are active on each platform for my team?",
    "Which platform contains the highest priority tasks across the team?",
    "Where is the majority of the team's estimated work being logged?",
    "Which platform has the oldest incomplete tasks assigned to the team?",

    // ⏱️ Team Time Management
    "How many tasks are due in the next 7 days across the team?",
    "What's the average time between task assignment and completion for the team?",
    "Which tasks have been in progress the longest?",
    "How much estimated work remains in the current sprint for the team?",
    "What's the team’s task velocity (tasks completed per week)?",

    // 🚦 Team Task Status & Workflow
    "How many tasks are currently in progress across the team?",
    "What percentage of tasks are completed vs. pending for the team?",
    "Which tasks assigned to team members have no status?",
    "How many tasks have been moved to 'Done' by the team this week?",
    "What is the current workload distribution by task status across the team?",

    // 📌 Team Priority Management
    "How are tasks distributed by priority level across the team?",
    "Which labels are used most frequently by the team?",
    "How many high-priority tasks are still incomplete for the team?",
    "What are the focus areas based on task labels across the team?",
    "Which priority levels take the team the longest to complete?",

    // 👥 Team Productivity Insights
    "Which day of the week is the team most productive?",
    "How has the team’s task completion trend changed over time?",
    "What is the team's average daily task completion count?",
    "Which types of tasks are completed fastest by the team?",
    "How consistent is the task completion rate across the team?",

    // 🧹 Team Task Hygiene
    "Which tasks haven't been updated in over 30 days?",
    "How many tasks are missing due dates across the team?",
    "Which tasks have no time estimates assigned?",
    "How many stale tasks need to be reviewed by the team?",
    "Which tasks need updates to their priority or status?"
];
...
function suggest() {
   ...
   async function snapCapture(divId) {
    ...
    @if (!DB::table('user_metrics')->where(['userid' => Auth('managers')->id()])->exists())
        // Get modal elements
