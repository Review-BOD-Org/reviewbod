<!-- views/dashboard.blade.php - Staff Performance Dashboard -->
@extends('dash.layouts.app')
@section('page-title', 'ReviewBOT')
@section('content')
<style>
.chat-button {
...
<div class="chat-container">
    ...
    <div class="chat-input-container mb-[50px]">
        <form id="send-bot" class="shadow shadow-lg rounded-lg border p-2">
