...
<div id="bulkActionsBar" class="bulk-actions-bar bg-blue-50 border-b border-blue-200 px-6 py-3 hidden">
                ...
                <tr class="hover:bg-gray-50/50" data-user-id="{{ $user->iid }}">
                    ...
                    <td class="py-4 px-6">
                        ...
                        @elseif($user->user_status == 'pending')
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">Pending Invite</span>
                        @elseif($user->user_status == 'active')
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Active</span>
                        @else
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">Not Invited</span>
                        @endif
                    </td>
                    <td class="py-4 px-6 text-sm text-gray-600">
                       {{ $user->created_at ? \Carbon\Carbon::parse($user->created_at)->format('Y - D - M') : '--' }}
                                                ...
                                                <td class="py-4 px-6">
                                                    <!-- UPDATED: Added proper classes for dropdown positioning -->
                                                    <div class="relative dropdown-container" x-data="{ open: false }">
                                                        ...
                                                        <!-- UPDATED: Applied dropdown-menu class -->
                                                        <div x-show="open"
                                                            ...
                                                            @if ($user->user_status != 'blocked' && $user->user_status != 'active')
                                                                @if ($user->email != 'N/A')
                                                                    <a href="#"
                                                                        ...
                                                                        onclick="send_invite('{{ $user->id }}','{{ $user->name }}','{{ $user->email }}')">Send
                                                                        Invitation</a>
                                                                @endif
                                                            @endif
                                                            ...
                                                            @if ($user->user_status == 'active')
                                                                <a href="#"
                                                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                                                    onclick="userstatus('{{$user->iid}}','blocked')">Restrict
                                                                    User</a>
                                                            @endif
                                                            ...
                                                            @if ($user->user_status == 'blocked')
                                                                <a href="#"
                                                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                                                    onclick="userstatus('{{$user->iid}}','active')">Unrestrict
                                                                    User</a>
                                                            @endif
                                                        </div>
                                                    </div>
